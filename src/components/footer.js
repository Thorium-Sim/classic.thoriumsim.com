    ...
    return (
      <FooterContainer>
        <Section>
          ...
          <InnerSection>
            <h4>Docs</h4>
            <Link css={linkStyle} to="/docs/getting_started">
              Getting Started
            </Link>
            <Link css={linkStyle} to="/docs/mission_writing">
              Mission Writing
            </Link>
            <Link css={linkStyle} to="/docs/developers">
              Developers
            </Link>
          </InnerSection>
          <InnerSection>
            ...
            <a css={linkStyle} href="https://discord.gg/UvxTQZz">
              Project Chat
            </a>
            <a
              css={linkStyle}
          ...
          <InnerSection>
            ...
            <a css={linkStyle} href="https://github.com/thorium-sim/thorium">
              GitHub
            </a>
          </InnerSection>
        </Section>
