  ...
  return (
    ...
    >
      ...
      <Page>
        ...
        excellent opportunity to learn about how Thorium was developed, pick up
        some new skills, make some new friends, and give back to Thorium and the
        Space Center community.
        <br />
        <h2
          css={css`
            margin-top: 10px;
        ...
        <ul>
          <li>
            <p>
              ...
              simulation and building Thorium. Participants should be willing to
              learn, work on projects, provide ideas and feedback, design
              screens and features, and most of all contribute to great projects
          ...
          <li>
            <strong>When:</strong> August 25, 2018 from 10:00am to 3:00pm. Lunch
            will be provided.
          </li>
          <li>
            <strong>Where:</strong>{' '}
            ...
            >
              Map
            </a>) or online - an interactive live-stream will (hopefully) be
            provided.
          </li>
          <li>
          ...
          <li>
            ...
            provided computers to work on actual code for Thorium. We'll provide
            several possible projects you can work on and learn from, as well as
            instruction on how Thorium works and the best way to get involved.
          </li>
        </ul>
        <h2
          css={css`
        ...
        <p>
          ...
          focused on the programming aspects of simulator controls, there are a
          lot of things that non-programmers can contribute:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            complete. You can play around with Thorium to learn how it works and
            then help to write documentation for the screens. You can also
        ...
        <h3>
          I want to learn how to program so I can contribute! Where do I start?
        </h3>
        <p>
          Learn Git. Git is an awesome tool that is used to keep track of
          changes to code and help multiple developers work on the same project
          at the same time. Thorium uses Git extensively.{' '}
        ...
        <p>
          ...
          JavaScript. The{' '}
          <a href="https://webdev-guild.github.io/" target="_blank">
            WebDev Guild
          </a>{' '}
        ...
        <p>
          ...
          that can walk you through the ropes. There's a lot of extra JavaScript
          stuff that will be helpful to know when learning React.{' '}
          <a
        ...
        <p>
          ...
          Thorium uses React with Apollo for the front-end and Node with Apollo
        ...
        <p>
          ...
          <a href="/docs/overview" target="_blank">
